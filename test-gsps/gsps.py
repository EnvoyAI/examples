...
def add_text_annotation(dicom, text, layer_name, bounding_box, anchor_point=None):
    ...
    ds_graphic_annotation.TextObjects = Sequence([ds_text_object])
